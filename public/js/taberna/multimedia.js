...
function creaCampos(contar,tipoM,classT){
	...
	if(tipoM=='video'){
		...
		jQuery('<p><label for="'+tipoM+'i_'+nbIteration+'"><input type="file" id="'+tipoM+'i_'+nbIteration+'" name="'+tipoM+'i_'+nbIteration+'" class="iframegeneraVideoO" data-tipo="'+tipoM+'" placeholder="texto"/></label><label for="'+tipoM+'i_'+nbIteration+'"><input type="number" id=""'+tipoM+'i_'+nbIteration+'" name=""'+tipoM+'i_'+nbIteration+'" maxlength="2" size="2" min="1" max="10" placeholder="posicion" /></label><textarea id="'+tipoM+'Desc'+nbIteration+'" name="'+tipoM+'Desc'+nbIteration+'"></textarea></p>').appendTo(scntDiv);
